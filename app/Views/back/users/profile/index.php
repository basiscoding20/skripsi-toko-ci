...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><?= isset($title)?$title:'Profile'; ?></h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('dashboard'); ?>" class="card-link float-left btn btn-sm btn-danger">Back</a>
                    <a href="<?= base_url('dashboard/profile/edit'); ?>" class="card-link float-right btn btn-sm btn-warning">Edit</a>
                </div>
            </div>
        </div>
    </div>
