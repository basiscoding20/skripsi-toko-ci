...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('dashboard/users/'.$users->id.'/update') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="customSwitch1" name="active" <?= ($users->active==1)?'checked':''; ?> >
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control <?php if(session('errors.role')) : ?>is-invalid<?php endif ?>" id="role" name="role" required>
                                    ...
                                    <option value="<?= $row->name; ?>" <?= (old('role')==$row->name)?'selected':(($users->rolename==$row->name)?'selected':''); ?> ><?= $row->name; ?></option>
