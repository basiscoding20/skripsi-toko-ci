...
<section class="page-section" id="products">
    <div class="container">
        <div class="text-left">
            <a href="<?= base_url('data/'.$list); ?>" class="btn btn-sm btn-info float-right">Selengkapnya</a>
            <h5 class="section-heading text-uppercase"><?= $title; ?></h5>
            <hr>
        </div>
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-footer">
                        <a href="<?= base_url('data/'.$row['type'].'/'.$row['categoryslug'].'/'.$row['slug']); ?>" class="card-link float-<?= ($row['type'] == 'product')?'left':'right'; ?> btn btn-sm btn-info">Detail</a>
            ...
            <?php echo $pager->links('list', 'bootstrap_pagination') ?>
        </div>
    </div>
</section>
<?= $this->endSection(); ?>